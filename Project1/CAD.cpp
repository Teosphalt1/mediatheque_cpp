...
{
	this->sCnx = "Data Source=PCGAEL\\MSSQL_GAEL;Initial Catalog=LIBRARY_CENTER;User ID=USER_ADMIN;Password=Galou3713!";	//Chaine de connexion à la base de données hébergée localement
	this->sSql = "Rien";
